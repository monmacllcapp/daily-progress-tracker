    ...
    return (
        <div className="h-full flex flex-col text-white overflow-hidden">
            ...
            <div className="flex items-center justify-between px-3 py-2 border-b border-white border-opacity-10">
                ...
                <div className="flex items-center gap-1">
                    ...
                    <button
                        ...
                        className="px-2 py-0.5 text-xs hover:bg-white hover:bg-opacity-10 rounded transition-colors"
                    >
            ...
            {allDayEvents.length > 0 && (
                <div className="px-3 py-1.5 border-b border-white border-opacity-5">
                    <span className="text-[10px] uppercase tracking-wider text-slate-500">All Day</span>
                    {allDayEvents.map(event => (
                        <div
                            key={event.id}
                            className="mt-1 px-2 py-1 rounded text-xs bg-blue-500 bg-opacity-20 text-blue-300"
                        >
                            {event.summary}
                        </div>
                    ))}
            ...
            <div className="flex-1 overflow-y-auto">
                <div className="relative" style={{ height: HOURS.length * HOUR_HEIGHT }}>
                    ...
                    {HOURS.map(hour => (
                        <div
                            key={hour}
                            className="absolute left-0 right-0 border-t border-white border-opacity-5 flex items-start"
                    ...
                    {isToday && currentHour >= 6 && currentHour <= 22 && (
                        ...
                        >
                            ...
                            <div className="flex-1 h-px bg-red-500 bg-opacity-60" />
                        </div>
                    )}
                                    ...
                                    <div className="flex items-center gap-1">
                                        ...
                                        {block.linkedTaskId && (
                                            <button
                                                ...
                                                className="p-0.5 hover:bg-emerald-500 hover:bg-opacity-20 rounded transition-colors opacity-0 group-hover:opacity-100 flex-shrink-0"
            ...
            {unscheduledTasks.length > 0 && (
                <div className="border-t border-white border-opacity-10 px-3 py-2 max-h-32 overflow-y-auto">
