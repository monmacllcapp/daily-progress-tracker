            ...
            <AnimatePresence mode="wait">
                {!isExpanded ? (
                    <motion.button
                        ...
                        className="w-full flex items-center gap-3 px-4 py-3 bg-white bg-opacity-5 border border-white border-opacity-10 rounded-xl text-slate-500 hover:text-white hover:bg-opacity-10 transition-all"
                    >
                        <Plus className="w-4 h-4" />
                        <span className="text-sm">Brain dump — type anything on your mind...</span>
                    </motion.button>
                ) : (
                    <motion.div
                        key="expanded"
                    ...
                    >
                        <textarea
                            ...
                            rows={4}
                            className="w-full bg-white bg-opacity-5 border border-white border-opacity-10 rounded-xl p-4 text-white placeholder-slate-600 focus:outline-none focus:border-blue-500 transition-colors resize-none text-sm"
                            autoFocus
                        />
                        <div className="flex items-center justify-between mt-2">
                            <span className="text-xs text-slate-600">
                                ...
                                {' · '}
                                <kbd className="px-1 py-0.5 bg-white bg-opacity-5 rounded text-[10px]">Cmd+Enter</kbd> to add
                            </span>
