...
import { parseStaffingWorkbook, recomputeKpiSummary } from '../services/staffing-data';
import { syncHubstaffHours, getLastSyncTime } from '../services/staffing-sync';
import type { ImportResult } from '../services/staffing-data';
import type { StaffMember, StaffPayPeriod, StaffExpense, StaffKpiSummary, StaffRole } from '../types/schema';
    ...
    return (
      <div className="h-full flex flex-col bg-slate-800 rounded-lg p-4 overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto space-y-1">
          {staffWithPeriods.map(({ member, totalPay, totalHours, totalDeals }) => {
