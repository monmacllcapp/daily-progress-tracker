...
import {
  ...
  Wallet, Building2, User, Clock, Search, Sparkles,
  Link2
} from 'lucide-react';
...
import { detectSubscriptions, flagUnusedSubscriptions, analyzeSpending, recomputeMonthlySummary } from '../services/financial-analysis';
